...
function getDescription(sendMode: SendMode) {
  switch (sendMode) {
    case SendMode.SEND:
      return `Send funds to another user on Nata Network via their alias. Transactions are end-to-end encrypted and fully private.`;
    case SendMode.WIDTHDRAW:
      return `Withdraw funds from Nata Network to a Polygon address. Depending on your initial deposit, large withdrawals can carry privacy risks.`;
    default:
      return '';
  }
}
