...
interface DonateSubmissionStepsProps {
...
const steps = [
  ...
  { phase: SendComposerPhase.COMPLETE_DONATE, label: 'Finalizing Donation'}
];
...
export function DonateSubmissionSteps({ composerState }: DonateSubmissionStepsProps) {
